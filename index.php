    ...
    <section class="w-[85%] max-w-[1440px] mx-auto mt-20 px-5">
        ...
        <div class="container mx-auto p-4">
            ...
            <div class="carousel-container">
                <!-- Navigation Arrows -->
                <button id="left-arrow" class="nav-arrow nav-arrow-left">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button id="right-arrow" class="nav-arrow nav-arrow-right">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
                ...
                <div id="events-container" class="scroll-container space-x-4">
        ...
        <script defer>
            ...
            function renderEvents(events) {
                ...
                if (events.length === 0) {
                    ...
                    events.forEach(event => {
                        ...
                        eventCard.className = 'event-card rounded-lg w-full sm:w-72';
                        eventCard.innerHTML = `
            ...
            function initializeCarousel() {
                ...
                function updateArrows() {
                    ...
                    rightArrow.style.display = currentIndex >= eventsContainer.children.length - 1 ? 'none' : 'block';
                }
                ...
                rightArrow.addEventListener('click', () => {
                    if (currentIndex < eventsContainer.children.length - 1) {
                        scrollToIndex(currentIndex + 1);
                    }
                });
                ...
                eventsContainer.addEventListener('touchmove', (e) => {
                    ...
                    if (Math.abs(diffX) > 50) {
                        if (diffX > 0 && currentIndex < eventsContainer.children.length - 1) {
                            scrollToIndex(currentIndex + 1);
